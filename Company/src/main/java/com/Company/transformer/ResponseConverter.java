...
public class ResponseConverter {
   ...
   public AddressResponse entityToAddressResponse(AddressModel addressEntity) {
	   ...
	   addressResponse.setCompany(addressEntity.getCompany());
 ...
 public List<AddressResponse> toAddressResponseList(List<AddressModel> addressModelList){
	 ...
	 return addressModelList.stream().map(p->new AddressResponse(p.getId(),p.getCity(),p.getState(),p.getPincode(),p.getCompany())).collect(Collectors.toList());
